...
export const LicenseCard = ({
    ...
    return (
        <div
            className="mx-auto flex max-w-[920px] cursor-pointer flex-col overflow-hidden rounded-3xl border-3 border-slate-100 bg-slate-100 transition-all hover:border-[#e9ebf1]"
            onClick={() => {
                if (onLicenseClick) {
